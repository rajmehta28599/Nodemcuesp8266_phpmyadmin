...
#define HOST "rajmehta.000webhostapp.com"          // Enter HOST URL without "http:// "  and "/" at the end of URL

#define WIFI_SSID "jsk"            // WIFI SSID here                                   
#define WIFI_PASSWORD "rajbhaimehta"        // WIFI password here
...
postData = "lat=" + sendval + "&longi=" + sendval2;
...
http.begin("http://rajmehta.000webhostapp.com/dbwrite.php");              // Connect to host where MySQL databse is hosted
